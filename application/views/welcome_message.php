...
<head>
    ...
    <link rel="apple-touch-icon" sizes="60x60" href="<?php echo base_url()."assets/";?>app-assets/img/ico/apple-icon-60.html">
    <link rel="apple-touch-icon" sizes="76x76" href="<?php echo base_url()."assets/";?>app-assets/img/ico/apple-icon-76.html">
    <link rel="apple-touch-icon" sizes="120x120" href="<?php echo base_url()."assets/";?>app-assets/img/ico/apple-icon-120.html">
    <link rel="apple-touch-icon" sizes="152x152" href="<?php echo base_url()."assets/";?>app-assets/img/ico/apple-icon-152.html">
    ...
    <link href="<?php echo base_url()."assets/";?>https://fonts.googleapis.com/css?family=Rubik:300,400,500,700,900|Montserrat:300,400,500,600,700,800,900" rel="stylesheet">
    <!-- BEGIN VENDOR CSS-->
    <!-- font icons-->
...
<div class="wrapper">
    ...
    <div data-active-color="white" data-background-color="man-of-steel" data-image="app-assets/img/sidebar-bg/01.jpg" class="app-sidebar">
        ...
        <div class="sidebar-header">
            <div class="logo clearfix"><a href="<?php echo base_url()."assets/";?>index-2.html" class="logo-text float-left">
                    <div class="logo-img"><img src="app-assets/img/logo.png"/></div><span class="text align-middle">APEX</span></a><a id="sidebarToggle" href="<?php echo base_url()."assets/";?>javascript:;" class="nav-toggle d-none d-sm-none d-md-none d-lg-block"><i data-toggle="expanded" class="ft-toggle-right toggle-icon"></i></a><a id="sidebarClose" href="<?php echo base_url()."assets/";?>javascript:;" class="nav-close d-block d-md-block d-lg-none d-xl-none"><i class="ft-x"></i></a></div>
        </div>
        <!-- Sidebar Header Ends-->
        <!-- / main menu header-->
        <!-- main menu content-->
        <div class="sidebar-content">
            <div class="nav-container">
                <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
                    <li class="has-sub nav-item"><a href="<?php echo base_url()."assets/";?>#"><i class="ft-home"></i><span data-i18n="" class="menu-title">Dashboard</span><span class="tag badge badge-pill badge-danger float-right mr-1 mt-1">2</span></a>
                        <ul class="menu-content">
                            <li class="active"><a href="<?php echo base_url()."assets/";?>dashboard1.html" class="menu-item">Dashboard1</a>
                            </li>
                            <li><a href="<?php echo base_url()."assets/";?>dashboard2.html" class="menu-item">Dashboard2</a>
                            </li>
                        </ul>
                    </li>
                    <li class=" nav-item"><a href="<?php echo base_url()."assets/";?>color-palette.html"><i class="ft-droplet"></i><span data-i18n="" class="menu-title">Color Palette</span></a>
                    </li>
                    <li class=" nav-item"><a href="<?php echo base_url()."assets/";?>inbox.html"><i class="ft-mail"></i><span data-i18n="" class="menu-title">Inbox</span></a>
                    </li>
                    <li class=" nav-item"><a href="<?php echo base_url()."assets/";?>chat.html"><i class="ft-message-square"></i><span data-i18n="" class="menu-title">Chat</span></a>
                    </li>
                    <li class=" nav-item"><a href="<?php echo base_url()."assets/";?>taskboard.html"><i class="ft-file-text"></i><span data-i18n="" class="menu-title">Task Board</span></a>
                    </li>
                    <li class="has-sub nav-item"><a href="<?php echo base_url()."assets/";?>#"><i class="ft-aperture"></i><span data-i18n="" class="menu-title">UI Kit</span></a>
                        <ul class="menu-content">
                            <li><a href="<?php echo base_url()."assets/";?>grids.html" class="menu-item">Grid</a>
                            </li>
                            <li><a href="<?php echo base_url()."assets/";?>typography.html" class="menu-item">Typography</a>
                            </li>
                            <li><a href="<?php echo base_url()."assets/";?>syntax-highlighter.html" class="menu-item">Syntax Highlighter</a>
                            </li>
                            <li><a href="<?php echo base_url()."assets/";?>helper-classes.html" class="menu-item">Helper Classes</a>
                            </li>
                            <li><a href="<?php echo base_url()."assets/";?>text-utilities.html" class="menu-item">Text Utilities</a>
                            </li>
                            <li class="has-sub"><a href="<?php echo base_url()."assets/";?>#" class="menu-item">Icons</a>
                                <ul class="menu-content">
                                    <li><a href="<?php echo base_url()."assets/";?>feather.html" class="menu-item">Feather Icon</a>
                                    </li>
                                    <li><a href="<?php echo base_url()."assets/";?>font-awesome.html" class="menu-item">Font Awesome Icon</a>
                                    </li>
                                    <li><a href="<?php echo base_url()."assets/";?>simple-line.html" class="menu-item">Simple Line Icon</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                    </li>
                    <li class="has-sub nav-item"><a href="<?php echo base_url()."assets/";?>#"><i class="ft-box"></i><span data-i18n="" class="menu-title">Components</span></a>
                        <ul class="menu-content">
                            <li class="has-sub"><a href="<?php echo base_url()."assets/";?>#" class="menu-item">Bootstrap</a>
                                <ul class="menu-content">
                                    <li><a href="<?php echo base_url()."assets/";?>components-lists.html" class="menu-item">List</a>
                                    </li>
                                    <li><a href="<?php echo base_url()."assets/";?>components-buttons.html" class="menu-item">Buttons</a>
                                    </li>
                                    <li><a href="<?php echo base_url()."assets/";?>components-alerts.html" class="menu-item">Alerts</a>
                                    </li>
                                    <li><a href="<?php echo base_url()."assets/";?>components-badges.html" class="menu-item">Badges</a>
                                    </li>
                                    <li><a href="<?php echo base_url()."assets/";?>components-dropdowns.html" class="menu-item">Dropdowns</a>
                                    </li>
                                    <li><a href="<?php echo base_url()."assets/";?>components-media-objects.html" class="menu-item">Media Objects</a>
                                    </li>
                                    <li><a href="<?php echo base_url()."assets/";?>components-pagination.html" class="menu-item">Pagination</a>
                                    </li>
                                    <li><a href="<?php echo base_url()."assets/";?>components-progress.html" class="menu-item">Progress Bars</a>
                                    </li>
                                    <li><a href="<?php echo base_url()."assets/";?>components-modals.html" class="menu-item">Modals</a>
                                    </li>
                                    <li><a href="<?php echo base_url()."assets/";?>components-collapse.html" class="menu-item">Collapse</a>
                                    </li>
                                    <li><a href="<?php echo base_url()."assets/";?>components-accordion.html" class="menu-item">Accordion</a>
                                    </li>
                                    <li><a href="<?php echo base_url()."assets/";?>components-carousel.html" class="menu-item">Carousel</a>
                                    </li>
                                    <li><a href="<?php echo base_url()."assets/";?>components-datepicker.html" class="menu-item">Datepicker</a>
                                    </li>
                                    <li><a href="<?php echo base_url()."assets/";?>components-popover.html" class="menu-item">Popover</a>
                                    </li>
                                    <li><a href="<?php echo base_url()."assets/";?>components-tabs.html" class="menu-item">Tabs</a>
                                    </li>
                                    <li><a href="<?php echo base_url()."assets/";?>components-tooltip.html" class="menu-item">Tooltip</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="has-sub"><a href="<?php echo base_url()."assets/";?>#" class="menu-item">Extra</a>
                                <ul class="menu-content">
                                    <li><a href="<?php echo base_url()."assets/";?>sweet-alerts.html" class="menu-item">Sweet Alert</a>
                                    </li>
                                    <li><a href="<?php echo base_url()."assets/";?>toastr.html" class="menu-item">Toastr</a>
                                    </li>
                                    <li><a href="<?php echo base_url()."assets/";?>nouislider.html" class="menu-item">NoUI Slider</a>
                                    </li>
                                    <li><a href="<?php echo base_url()."assets/";?>upload.html" class="menu-item">Upload</a>
                                    </li>
                                    <li><a href="<?php echo base_url()."assets/";?>editor.html" class="menu-item">Editor</a>
                                    </li>
                                    <li><a href="<?php echo base_url()."assets/";?>dragndrop.html" class="menu-item">Drag and Drop</a>
                                    </li>
                                    <li><a href="<?php echo base_url()."assets/";?>tour.html" class="menu-item">Tour</a>
                                    </li>
                                    <li><a href="<?php echo base_url()."assets/";?>image-cropper.html" class="menu-item">Image Cropper</a>
                                    </li>
                                    <li><a href="<?php echo base_url()."assets/";?>tags-input.html" class="menu-item">Input Tag</a>
                                    </li>
                                    <li><a href="<?php echo base_url()."assets/";?>switch.html" class="menu-item">Switch</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                    </li>
                    <li class="has-sub nav-item"><a href="<?php echo base_url()."assets/";?>#"><i class="ft-edit"></i><span data-i18n="" class="menu-title">Forms</span></a>
                        <ul class="menu-content">
                            <li class="has-sub"><a href="<?php echo base_url()."assets/";?>#" class="menu-item">Elements</a>
                                <ul class="menu-content">
                                    <li><a href="<?php echo base_url()."assets/";?>inputs.html" class="menu-item">Inputs</a>
                                    </li>
                                    <li><a href="<?php echo base_url()."assets/";?>input-groups.html" class="menu-item">Input Groups</a>
                                    </li>
                                    <li><a href="<?php echo base_url()."assets/";?>input-grid.html" class="menu-item">Input Grid</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="has-sub"><a href="<?php echo base_url()."assets/";?>#" class="menu-item">Layouts</a>
                                <ul class="menu-content">
                                    <li><a href="<?php echo base_url()."assets/";?>basic-forms.html" class="menu-item">Basic Forms</a>
                                    </li>
                                    <li><a href="<?php echo base_url()."assets/";?>horizontal-forms.html" class="menu-item">Horizontal Forms</a>
                                    </li>
                                    <li><a href="<?php echo base_url()."assets/";?>hidden-labels.html" class="menu-item">Hidden Labels</a>
                                    </li>
                                    <li><a href="<?php echo base_url()."assets/";?>form-actions.html" class="menu-item">Form Actions</a>
                                    </li>
                                    <li><a href="<?php echo base_url()."assets/";?>bordered-forms.html" class="menu-item">Bordered Forms</a>
                                    </li>
                                    <li><a href="<?php echo base_url()."assets/";?>striped-rows.html" class="menu-item">Striped Rows</a>
                                    </li>
                                </ul>
                            </li>
                            <li><a href="<?php echo base_url()."assets/";?>validation-forms.html" class="menu-item">Validation</a>
                            </li>
                            <li><a href="<?php echo base_url()."assets/";?>wizard-forms.html" class="menu-item">Wizard</a>
                            </li>
                        </ul>
                    </li>
                    <li class="has-sub nav-item"><a href="<?php echo base_url()."assets/";?>#"><i class="ft-grid"></i><span data-i18n="" class="menu-title">Tables</span></a>
                        <ul class="menu-content">
                            <li><a href="<?php echo base_url()."assets/";?>regular-table.html" class="menu-item">Regular</a>
                            </li>
                            <li><a href="<?php echo base_url()."assets/";?>extended-table.html" class="menu-item">Extended</a>
                            </li>
                        </ul>
                    </li>
                    <li class="has-sub nav-item"><a href="<?php echo base_url()."assets/";?>#"><i class="ft-layout"></i><span data-i18n="" class="menu-title">Data Tables</span></a>
                        <ul class="menu-content">
                            <li><a href="<?php echo base_url()."assets/";?>dt-basic-initialization.html" class="menu-item">Basic Initialisation</a>
                            </li>
                            <li><a href="<?php echo base_url()."assets/";?>dt-advanced-initialization.html" class="menu-item">Advanced initialisation</a>
                            </li>
                            <li><a href="<?php echo base_url()."assets/";?>dt-styling.html" class="menu-item">Styling</a>
                            </li>
                            <li><a href="<?php echo base_url()."assets/";?>dt-data-sources.html" class="menu-item">Data Sources</a>
                            </li>
                            <li><a href="<?php echo base_url()."assets/";?>dt-api.html" class="menu-item">API</a>
                            </li>
                        </ul>
                    </li>
                    <li class="has-sub nav-item"><a href="<?php echo base_url()."assets/";?>#"><i class="ft-layers"></i><span data-i18n="" class="menu-title">Cards</span></a>
                        <ul class="menu-content">
                            <li><a href="<?php echo base_url()."assets/";?>basic-cards.html" class="menu-item">Basic Cards</a>
                            </li>
                            <li><a href="<?php echo base_url()."assets/";?>advanced-cards.html" class="menu-item">Advanced Cards</a>
                            </li>
                        </ul>
                    </li>
                    <li class="has-sub nav-item"><a href="<?php echo base_url()."assets/";?>#"><i class="ft-layers"></i><span data-i18n="" class="menu-title">Maps</span></a>
                        <ul class="menu-content">
                            <li><a href="<?php echo base_url()."assets/";?>google-map.html" class="menu-item">Google Map</a>
                            </li>
                        </ul>
                    </li>
                    <li class="has-sub nav-item"><a href="<?php echo base_url()."assets/";?>#"><i class="ft-bar-chart-2"></i><span data-i18n="" class="menu-title">Charts</span></a>
                        <ul class="menu-content">
                            <li><a href="<?php echo base_url()."assets/";?>chartjs.html" class="menu-item">ChartJs</a>
                            </li>
                            <li><a href="<?php echo base_url()."assets/";?>chartist.html" class="menu-item">Chartist</a>
                            </li>
                        </ul>
                    </li>
                    <li class=" nav-item"><a href="<?php echo base_url()."assets/";?>calendar.html"><i class="ft-calendar"></i><span data-i18n="" class="menu-title">Calendar</span></a>
                    </li>
                    <li class="has-sub nav-item"><a href="<?php echo base_url()."assets/";?>#"><i class="ft-copy"></i><span data-i18n="" class="menu-title">Pages</span></a>
                        <ul class="menu-content">
                            <li><a href="<?php echo base_url()."assets/";?>forgot-password-page.html" class="menu-item">Forgot Password</a>
                            </li>
                            <li><a href="<?php echo base_url()."assets/";?>horizontal-timeline-page.html" class="menu-item">Horizontal Timeline</a>
                            </li>
                            <li><a href="<?php echo base_url()."assets/";?>vertical-timeline-page.html" class="menu-item">Vertical Timeline</a>
                            </li>
                            <li><a href="<?php echo base_url()."assets/";?>login-page.html" class="menu-item">Login</a>
                            </li>
                            <li><a href="<?php echo base_url()."assets/";?>register-page.html" class="menu-item">Register</a>
                            </li>
                            <li><a href="<?php echo base_url()."assets/";?>user-profile-page.html" class="menu-item">User Profile</a>
                            </li>
                            <li><a href="<?php echo base_url()."assets/";?>lock-screen-page.html" class="menu-item">Lock Screen</a>
                            </li>
                            <li><a href="<?php echo base_url()."assets/";?>invoice-page.html" class="menu-item">Invoice</a>
                            </li>
                            <li><a href="<?php echo base_url()."assets/";?>error-page.html" class="menu-item">Error</a>
                            </li>
                            <li><a href="<?php echo base_url()."assets/";?>coming-soon-page.html" class="menu-item">Coming Soon</a>
                            </li>
                            <li><a href="<?php echo base_url()."assets/";?>maintenance-page.html" class="menu-item">Maintenance</a>
                            </li>
                            <li><a href="<?php echo base_url()."assets/";?>gallery-page.html" class="menu-item">Gallery</a>
                            </li>
                        </ul>
                    </li>
                    <li class=" nav-item"><a href="<?php echo base_url()."assets/";?>https://pixinvent.com/apex-angular-4-bootstrap-admin-template/documentation"><i class="ft-book"></i><span data-i18n="" class="menu-title">Documentation</span></a>
                    </li>
                    <li class=" nav-item"><a href="<?php echo base_url()."assets/";?>https://pixinvent.ticksy.com/"><i class="ft-life-buoy"></i><span data-i18n="" class="menu-title">Support</span></a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="container-fluid">
            ...
            <div class="navbar-container">
                <div id="navbarSupportedContent" class="collapse navbar-collapse">
                    <ul class="navbar-nav">
                        <li class="nav-item mr-2"><a id="navbar-fullscreen" href="<?php echo base_url()."assets/";?>javascript:;" class="nav-link apptogglefullscreen"><i class="ft-maximize font-medium-3 blue-grey darken-4"></i>
                                <p class="d-none">fullscreen</p></a></li>
                        <li class="dropdown nav-item"><a id="dropdownBasic3" href="<?php echo base_url()."assets/";?>#" data-toggle="dropdown" class="nav-link position-relative dropdown-toggle"><i class="ft-flag font-medium-3 blue-grey darken-4"></i><span class="selected-language d-none"></span></a>
                            <div class="dropdown-menu dropdown-menu-right"><a href="<?php echo base_url()."assets/";?>javascript:;" class="dropdown-item py-1"><img src="app-assets/img/flags/us.png" class="langimg"/><span> English</span></a><a href="<?php echo base_url()."assets/";?>javascript:;" class="dropdown-item py-1"><img src="app-assets/img/flags/es.png" class="langimg"/><span> Spanish</span></a><a href="<?php echo base_url()."assets/";?>javascript:;" class="dropdown-item py-1"><img src="app-assets/img/flags/br.png" class="langimg"/><span> Portuguese</span></a><a href="<?php echo base_url()."assets/";?>javascript:;" class="dropdown-item"><img src="app-assets/img/flags/de.png" class="langimg"/><span> French</span></a></div>
                        </li>
                        <li class="dropdown nav-item"><a id="dropdownBasic2" href="<?php echo base_url()."assets/";?>#" data-toggle="dropdown" class="nav-link position-relative dropdown-toggle"><i class="ft-bell font-medium-3 blue-grey darken-4"></i><span class="notification badge badge-pill badge-danger">4</span>
                        ...
                        <li class="dropdown nav-item"><a id="dropdownBasic3" href="<?php echo base_url()."assets/";?>#" data-toggle="dropdown" class="nav-link position-relative dropdown-toggle"><i class="ft-user font-medium-3 blue-grey darken-4"></i>
                                <p class="d-none">User Settings</p></a>
                            <div ngbdropdownmenu="" aria-labelledby="dropdownBasic3" class="dropdown-menu dropdown-menu-right"><a href="<?php echo base_url()."assets/";?>javascript:;" class="dropdown-item py-1"><i class="ft-settings mr-2"></i><span>Settings</span></a><a href="<?php echo base_url()."assets/";?>javascript:;" class="dropdown-item py-1"><i class="ft-edit mr-2"></i><span>Edit Profile</span></a><a href="<?php echo base_url()."assets/";?>javascript:;" class="dropdown-item py-1"><i class="ft-mail mr-2"></i><span>My Inbox</span></a>
                                <div class="dropdown-divider"></div><a href="<?php echo base_url()."assets/";?>javascript:;" class="dropdown-item"><i class="ft-power mr-2"></i><span>Logout</span></a>
                            </div>
                        </li>
                        <li class="nav-item"><a href="<?php echo base_url()."assets/";?>javascript:;" class="nav-link position-relative notification-sidebar-toggle"><i class="ft-align-left font-medium-3 blue-grey darken-4"></i>
    ...
    <div class="main-panel">
        ...
        <footer class="footer footer-static footer-light">
            <p class="clearfix text-muted text-sm-center px-2"><span>Copyright  &copy; 2018 <a href="<?php echo base_url()."assets/";?>https://themeforest.net/user/pixinvent/portfolio?ref=pixinvent" id="pixinventLink" target="_blank" class="text-bold-800 primary darken-2">PIXINVENT </a>, All rights reserved. </span></p>
        </footer>
        ...
        <div class="row">
            <div class="col-12 mt-1">
                <ul class="nav nav-tabs">
                    <li class="nav-item"><a id="base-tab1" data-toggle="tab" aria-controls="tab1" href="<?php echo base_url()."assets/";?>#activity-tab" aria-expanded="true" class="nav-link active">Activity</a></li>
                    <li class="nav-item"><a id="base-tab2" data-toggle="tab" aria-controls="tab2" href="<?php echo base_url()."assets/";?>#chat-tab" aria-expanded="false" class="nav-link">Chat</a></li>
                    <li class="nav-item"><a id="base-tab3" data-toggle="tab" aria-controls="tab3" href="<?php echo base_url()."assets/";?>#settings-tab" aria-expanded="false" class="nav-link">Settings</a></li>
                </ul>
                            ...
                            <div id="timeline" class="timeline-left timeline-wrapper">
                                <ul class="timeline">
                                    ...
                                    <li class="timeline-item">
                                        ...
                                        <div class="col s9 recent-activity-list-text"><a href="<?php echo base_url()."assets/";?>#" class="deep-purple-text medium-small">just now</a>
                                            <p class="mt-0 mb-2 fixed-line-height font-weight-300 medium-small">Jim Doe Purchased new equipments for zonal office.</p>
                                        </div>
                                    </li>
                                    <li class="timeline-item">
                                        <div class="timeline-badge"><span data-toggle="tooltip" data-placement="right" title="Portfolio project work" class="bg-info bg-lighten-1"><i class="fa fa-plane"></i></span></div>
                                        <div class="col s9 recent-activity-list-text"><a href="<?php echo base_url()."assets/";?>#" class="cyan-text medium-small">Yesterday</a>
                                            <p class="mt-0 mb-2 fixed-line-height font-weight-300 medium-small">Your Next flight for USA will be on 15th August 2015.</p>
                                        </div>
                                    </li>
                                    <li class="timeline-item">
                                        <div class="timeline-badge"><span data-toggle="tooltip" data-placement="right" title="Portfolio project work" class="bg-success bg-lighten-1"><i class="ft-mic"></i></span></div>
                                        <div class="col s9 recent-activity-list-text"><a href="<?php echo base_url()."assets/";?>#" class="green-text medium-small">5 Days Ago</a>
                                            <p class="mt-0 mb-2 fixed-line-height font-weight-300 medium-small">Natalya Parker Send you a voice mail for next conference.</p>
                                        </div>
                                    </li>
                                    <li class="timeline-item">
                                        <div class="timeline-badge"><span data-toggle="tooltip" data-placement="right" title="Portfolio project work" class="bg-warning bg-lighten-1"><i class="ft-map-pin"></i></span></div>
                                        <div class="col s9 recent-activity-list-text"><a href="<?php echo base_url()."assets/";?>#" class="amber-text medium-small">1 Week Ago</a>
                                            <p class="mt-0 mb-2 fixed-line-height font-weight-300 medium-small">Jessy Jay open a new store at S.G Road.</p>
                                        </div>
                                    </li>
                                    <li class="timeline-item">
                                        <div class="timeline-badge"><span data-toggle="tooltip" data-placement="right" title="Portfolio project work" class="bg-red bg-lighten-1"><i class="ft-inbox"></i></span></div>
                                        <div class="col s9 recent-activity-list-text"><a href="<?php echo base_url()."assets/";?>#" class="deep-orange-text medium-small">2 Week Ago</a>
                                            <p class="mt-0 mb-2 fixed-line-height font-weight-300 medium-small">voice mail for conference.</p>
                                        </div>
                                    </li>
                                    <li class="timeline-item">
                                        <div class="timeline-badge"><span data-toggle="tooltip" data-placement="right" title="Portfolio project work" class="bg-cyan bg-lighten-1"><i class="ft-mic"></i></span></div>
                                        <div class="col s9 recent-activity-list-text"><a href="<?php echo base_url()."assets/";?>#" class="brown-text medium-small">1 Month Ago</a>
                                            <p class="mt-0 mb-2 fixed-line-height font-weight-300 medium-small">Natalya Parker Send you a voice mail for next conference.</p>
                                        </div>
                                    </li>
                                    <li class="timeline-item">
                                        <div class="timeline-badge"><span data-toggle="tooltip" data-placement="right" title="Portfolio project work" class="bg-amber bg-lighten-1"><i class="ft-map-pin"></i></span></div>
                                        <div class="col s9 recent-activity-list-text"><a href="<?php echo base_url()."assets/";?>#" class="deep-purple-text medium-small">3 Month Ago</a>
                                            <p class="mt-0 mb-2 fixed-line-height font-weight-300 medium-small">Jessy Jay open a new store at S.G Road.</p>
                                        </div>
                                    </li>
                                    <li class="timeline-item">
                                        <div class="timeline-badge"><span data-toggle="tooltip" data-placement="right" title="Portfolio project work" class="bg-grey bg-lighten-1"><i class="ft-inbox"></i></span></div>
                                        <div class="col s9 recent-activity-list-text"><a href="<?php echo base_url()."assets/";?>#" class="grey-text medium-small">1 Year Ago</a>
                                            <p class="mt-0 mb-2 fixed-line-height font-weight-300 medium-small">voice mail for conference.</p>
                                        </div>
                                    </li>
                                </ul>
